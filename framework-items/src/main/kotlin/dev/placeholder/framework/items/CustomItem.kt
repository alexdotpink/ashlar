...
public class CustomItemDefinition<T> internal constructor(
    ...
    public fun create(
        ...
        val presentationBytes = if (integrity?.includePresentation == true) stack.serializeAsBytes() else null
    ...
    public companion object {
        ...
        public val ENVELOPE_KEY: NamespacedKey = NamespacedKey("framework", "custom_item")
    }
}
