...
internal class EventSetReader {
    ...
    private companion object {
        const val ON_ANNOTATION = "pink.alex.ashlar.events.On"
        const val OBSERVE_ANNOTATION = "pink.alex.ashlar.events.Observe"
        const val ON_APPLICATION_ANNOTATION = "pink.alex.ashlar.events.OnApplication"
        const val CONFIGURE_LIFECYCLE_ANNOTATION =
            "pink.alex.ashlar.events.ConfigureLifecycleEvents"
        const val DISABLE_HANDLER_ANNOTATION = "pink.alex.ashlar.events.DisableEventHandler"
        const val APPLICATION_EVENT_TYPE = "pink.alex.ashlar.events.ApplicationEvent"
