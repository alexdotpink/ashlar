...
import dev.placeholder.framework.commands.codegen.CommandOptionMemberDefinition
import dev.placeholder.framework.commands.codegen.CommandOptionsDefinition
...
class ScannedCommandArgumentsTest {
    ...
    fun `requires a non-null direct option`() {
        ...
        val failure = assertFailsWith<dev.placeholder.framework.commands.codec.CommandArgumentException> {
