...
import pink.alex.ashlar.menus.ChestHostSnapshot
...
import pink.alex.ashlar.menus.MenuInspection
...
import pink.alex.ashlar.menus.MenuInterceptor
import pink.alex.ashlar.menus.MenuObserver
import pink.alex.ashlar.menus.MenuRegistration
...
public class MenuTestScope internal constructor(
    ...
    public fun player(name: String): PlayerRef {
        ...
        return PlayerRef(
            UUID.nameUUIDFromBytes("ashlar-menu:$name".toByteArray(StandardCharsets.UTF_8)),
        )
    }
...
public class MenuTestSession internal constructor(
    ...
    private val core: pink.alex.ashlar.menus.MenuSessionCore,
...
internal class TestNativeHost(
    ...
    override suspend fun commitTransaction(transaction: MenuNativeTransaction): MenuNativeCommit {
        ...
        transaction.committed.emissions.forEach { emission ->
            when (emission) {
                is pink.alex.ashlar.menus.storage.MenuTransactionEmission.Drop -> emissions += emission.item
            }
        }
