 ...
 *
 * The capability may be captured, but its proof is not permanent. Ashlar modules must give
...
public class EntityContext internal constructor(
     ...
     *
     * Ashlar operations must call this immediately before touching Paper state.
     *
 ...
 *
 * Ashlar modules must name their [RegionContext] context parameter and call [checkOwnership]
 ...
 *
 * Ashlar modules must name their [GlobalContext] context parameter and call [checkOwnership]
 * immediately before each Paper operation. An anonymous context parameter does not revalidate a
 * capability that escaped its original ownership block.
 */
