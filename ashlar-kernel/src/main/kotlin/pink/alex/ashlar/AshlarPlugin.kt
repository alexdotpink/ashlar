...
public abstract class AshlarPlugin : JavaPlugin() {
    ...
    private fun automaticComponentDeclarations(
        ...
        val ordered = mutableListOf<pink.alex.ashlar.di.RootComponentContribution>()
        ...
        return ordered.map { contribution ->
            check(PluginComponent::class.java.isAssignableFrom(contribution.type.java)) {
                "${contribution.type.qualifiedName} is marked @AshlarComponent but does not extend PluginComponent"
            }
