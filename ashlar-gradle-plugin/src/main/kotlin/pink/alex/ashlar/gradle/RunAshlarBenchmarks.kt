...
public abstract class RunAshlarBenchmarks : JavaExec() {
    @get:Input
    ...
    @get:Input
    public abstract val ashlarVersion: Property<String>
    ...
    @get:Optional
    @get:OutputFile
    public abstract val recordingFile: RegularFileProperty
    ...
    override fun exec() {
        val arguments = mutableListOf(
            ...
            "--ashlar-version", ashlarVersion.get(),
        ...
        setArgs(arguments)
        systemProperty("ashlar.benchmark.classDirs", benchmarkClassDirectories.asPath)
        super.exec()
    }
}
