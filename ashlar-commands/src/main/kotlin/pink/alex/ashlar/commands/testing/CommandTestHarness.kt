...
import pink.alex.ashlar.commands.internal.BuiltinCodecs
import pink.alex.ashlar.commands.internal.ScannedCommandArguments
...
public class CommandTestHarness(
    ...
    private fun codec(parameter: pink.alex.ashlar.commands.codegen.CommandParameterDefinition):
