package pink.alex.ashlar.input.testing

import pink.alex.ashlar.execution.PlayerRef
import pink.alex.ashlar.input.EnglishInputMessages
import pink.alex.ashlar.input.InputDelivery
import pink.alex.ashlar.input.InputMessages
...
public class InputTestHarness(
    ...
    public fun player(
        ...
        val reference = PlayerRef(
            UUID.nameUUIDFromBytes("ashlar-input:$name".toByteArray(StandardCharsets.UTF_8)),
        )
