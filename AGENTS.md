...
- Read [docs/agents/menu-implementation.md](docs/agents/menu-implementation.md) before implementing items, menus, inventory hosts, menu storage, or menu tests. These modules are approved designs, not shipped APIs.
