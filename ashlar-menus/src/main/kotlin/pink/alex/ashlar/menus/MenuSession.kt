...
import pink.alex.ashlar.menus.internal.paper.PaperMenuNativeHostFactory
import pink.alex.ashlar.menus.internal.paper.PaperMenuPlayerSettlement
import pink.alex.ashlar.menus.storage.FileMenuTransactionJournal
...
import pink.alex.ashlar.menus.storage.MenuTransactionSubmission
...
@AshlarComponent(name = "menus", phase = ComponentPhase.FRAMEWORK)
...
internal class MenuSessionCore(
    ...
    private fun dispatchStorage(
        ...
        val storageValues = linkedMapOf<MenuStorageId, pink.alex.ashlar.menus.storage.MenuStorageSnapshot>()
...
private fun RenderTree.snapshot(
    ...
    return MenuRenderSnapshot(
        ...
        storages.keys.mapTo(linkedSetOf(), pink.alex.ashlar.menus.storage.MenuStorageReference::Storage) +
            playerInventory.mapTo(linkedSetOf(), pink.alex.ashlar.menus.storage.MenuStorageReference::Player),
