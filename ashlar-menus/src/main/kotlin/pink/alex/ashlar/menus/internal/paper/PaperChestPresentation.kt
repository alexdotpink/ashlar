...
import pink.alex.ashlar.items.ItemPresentation
import pink.alex.ashlar.items.ItemPresentationContext
import pink.alex.ashlar.items.Items
import pink.alex.ashlar.menus.AnvilHostSnapshot
import pink.alex.ashlar.menus.BeaconHostSnapshot
import pink.alex.ashlar.menus.BrewingHostSnapshot
import pink.alex.ashlar.menus.CrafterHostSnapshot
import pink.alex.ashlar.menus.EnchantmentHostSnapshot
import pink.alex.ashlar.menus.FurnaceHostKind
import pink.alex.ashlar.menus.FurnaceHostSnapshot
import pink.alex.ashlar.menus.LecternHostSnapshot
import pink.alex.ashlar.menus.LecternSlot
import pink.alex.ashlar.menus.MenuHostSnapshot
import pink.alex.ashlar.menus.MerchantHostSnapshot
...
internal object PaperChestPresentation {
    ...
    private fun applyProperties(
        ...
        when (host) {
            ...
            is CrafterHostSnapshot -> (view as CrafterView).let { crafter ->
                pink.alex.ashlar.menus.CrafterSlot.entries.forEach { slot ->
    ...
    internal fun nativeKind(host: MenuHostSnapshot): PaperMenuKind = when (host) {
        ...
        is pink.alex.ashlar.menus.HopperHostSnapshot -> PaperMenuKind.HOPPER
        is pink.alex.ashlar.menus.Generic3x3HostSnapshot -> PaperMenuKind.GENERIC_3X3
        is pink.alex.ashlar.menus.ShulkerHostSnapshot -> PaperMenuKind.SHULKER_BOX
        ...
        is pink.alex.ashlar.menus.CraftingHostSnapshot -> PaperMenuKind.CRAFTING
        is CrafterHostSnapshot -> PaperMenuKind.CRAFTER_3X3
        is EnchantmentHostSnapshot -> PaperMenuKind.ENCHANTMENT
        is pink.alex.ashlar.menus.GrindstoneHostSnapshot -> PaperMenuKind.GRINDSTONE
        is pink.alex.ashlar.menus.SmithingHostSnapshot -> PaperMenuKind.SMITHING
        is pink.alex.ashlar.menus.LoomHostSnapshot -> PaperMenuKind.LOOM
        is pink.alex.ashlar.menus.CartographyHostSnapshot -> PaperMenuKind.CARTOGRAPHY_TABLE
        is pink.alex.ashlar.menus.StonecutterHostSnapshot -> PaperMenuKind.STONECUTTER
