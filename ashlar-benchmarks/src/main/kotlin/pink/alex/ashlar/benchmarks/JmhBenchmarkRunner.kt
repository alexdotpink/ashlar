...
import pink.alex.ashlar.benchmarks.internal.JmhScenarioBenchmark
import java.io.File
...
public class JmhBenchmarkRunner(
    ...
    private fun runCase(
        ...
        val properties = mapOf(
            "ashlar.benchmark.classDirs" to classDirectories.joinToString(File.pathSeparator),
            "ashlar.benchmark.scenario" to scenario.id.value,
            "ashlar.benchmark.profile" to profile.name,
            "ashlar.benchmark.layer" to layer.name,
            "ashlar.benchmark.temperature" to temperature.name,
        )
