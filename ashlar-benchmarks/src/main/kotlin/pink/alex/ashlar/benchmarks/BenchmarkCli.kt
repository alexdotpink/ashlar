...
public object BenchmarkCli {
    ...
    private fun run(arguments: List<String>, output: PrintStream): Int {
        ...
        val environment = MeasurementEnvironment.local(
            ashlarVersion = options.value("ashlar-version") ?: "development",
    ...
    private fun build(arguments: List<String>, output: PrintStream): Int {
        ...
        val environment = MeasurementEnvironment.local(
            ...
            attributes = mapOf("workload" to "ashlar-build"),
        )
    ...
    private fun catalogue(arguments: List<String>, output: PrintStream, error: PrintStream): Int {
        ...
        val report = AshlarPerformanceCatalogue.catalogue.validate(
            suites = suites,
    ...
    private fun configuredClassDirectories(): List<String> =
        System.getProperty("ashlar.benchmark.classDirs")
