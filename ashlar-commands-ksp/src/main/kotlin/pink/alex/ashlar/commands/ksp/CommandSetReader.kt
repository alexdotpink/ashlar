...
internal class CommandSetReader {
    ...
    private fun readAliasAnnotations(resolver: Resolver): Map<String, Set<String>> {
        ...
        val frameworkAliases = resolver.getDeclarationsFromPackage("pink.alex.ashlar.commands")
            .filterIsInstance<KSTypeAlias>()
    ...
    private companion object {
        ...
        const val COMMAND_ANNOTATION = "pink.alex.ashlar.commands.Command"
        const val GROUP_ANNOTATION = "pink.alex.ashlar.commands.Group"
        const val SCOPE_ANNOTATION = "pink.alex.ashlar.commands.Scope"
        const val ROOT_ANNOTATION = "pink.alex.ashlar.commands.Root"
        const val GREEDY_ANNOTATION = "pink.alex.ashlar.commands.Greedy"
        const val REPEATED_ANNOTATION = "pink.alex.ashlar.commands.Repeated"
        const val OPTION_ANNOTATION = "pink.alex.ashlar.commands.Option"
        const val OPTIONS_ANNOTATION = "pink.alex.ashlar.commands.Options"
        const val OPTION_VALUE_TYPE = "pink.alex.ashlar.commands.OptionValue"
        const val LIST_TYPE = "kotlin.collections.List"
        const val RENAMED_ANNOTATION = "pink.alex.ashlar.commands.CommandRenamed"
        const val CENTER_INTEGERS_ANNOTATION =
            "pink.alex.ashlar.commands.minecraft.CenterIntegers"
        const val MINIMUM_TICKS_ANNOTATION =
            "pink.alex.ashlar.commands.minecraft.MinimumTicks"
        const val FROM_REGISTRY_ANNOTATION =
            "pink.alex.ashlar.commands.minecraft.FromRegistry"
        const val SENSITIVE_ANNOTATION = "pink.alex.ashlar.commands.Sensitive"
        const val OBSERVED_ANNOTATION = "pink.alex.ashlar.commands.Observed"
        const val COMMAND_ARGUMENT_QUALIFIER =
            "pink.alex.ashlar.commands.codec.CommandArgumentQualifier"
        const val COOLDOWN_ANNOTATION = "pink.alex.ashlar.commands.policy.Cooldown"
        const val RATE_LIMIT_ANNOTATION = "pink.alex.ashlar.commands.policy.RateLimit"
        const val SINGLE_FLIGHT_ANNOTATION = "pink.alex.ashlar.commands.policy.SingleFlight"
        const val CONFIRM_ANNOTATION = "pink.alex.ashlar.commands.policy.Confirm"
        const val COMMAND_POLICY_ANNOTATION = "pink.alex.ashlar.commands.policy.CommandPolicy"
        const val CANCEL_ON_RETIRE_ANNOTATION =
            "pink.alex.ashlar.commands.policy.CancelOnExecutorRetire"
        const val CONFIGURE_GRAPH_ANNOTATION = "pink.alex.ashlar.commands.ConfigureCommandGraph"
    }
}
