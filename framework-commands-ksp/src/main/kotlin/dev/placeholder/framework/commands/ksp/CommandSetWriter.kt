...
internal class CommandSetWriter {
    ...
    private companion object {
        val COMMAND_SET_BINDING = ClassName(
            "dev.placeholder.framework.commands.codegen",
            "CommandSetBinding",
        )
        ...
        val COMMAND_POLICY_DEFINITION = ClassName(
            "dev.placeholder.framework.commands.policy",
        ...
        val OPTION_VALUE = ClassName("dev.placeholder.framework.commands", "OptionValue")
        val MISSING_ARGUMENT = ClassName(
            "dev.placeholder.framework.commands.codegen",
            "MissingCommandArgument",
        )
        val DEPENDENCY_RESOLVER = ClassName("dev.placeholder.framework.di", "DependencyResolver")
        ...
        val COMMAND_ROUTE = ClassName("dev.placeholder.framework.commands.route", "CommandRoute")
        val COMMAND_ROUTE_ENCODER = ClassName("dev.placeholder.framework.commands.route", "CommandRouteEncoder")
        val COMMAND_GRAPH = ClassName("dev.placeholder.framework.commands.graph", "CommandGraph")
        val SENSITIVE_ROUTE_VALUE = ClassName(
            "dev.placeholder.framework.commands.route",
            "SensitiveRouteValue",
        )
        ...
        val PLUGIN_COMPONENT = ClassName("dev.placeholder.framework", "PluginComponent")
