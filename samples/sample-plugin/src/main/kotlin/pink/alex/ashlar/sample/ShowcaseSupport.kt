...
import pink.alex.ashlar.commands.codec.CommandArgumentQualifier
...
import pink.alex.ashlar.di.Contributes
...
internal class LandmarkCodec : CommandArgumentCodec<LandmarkName> {
    ...
    override suspend fun resolve(
        ...
        dependencies: pink.alex.ashlar.di.DependencyResolver,
...
internal class ShowcaseHelpRenderer : CommandHelpRenderer {
    override fun render(
        ...
        sender: pink.alex.ashlar.commands.CommandSender,
        page: Int,
