...
import pink.alex.ashlar.events.retry
import pink.alex.ashlar.events.skip
    ...
    internal suspend fun PlayerJoinEvent.welcome() {
        ...
        player.access(plugin) { resolved ->
            resolved.sendMessage(
                Component.text("Ashlar events are ready. ", NamedTextColor.GREEN)
                    .append(
...
@AshlarComponent(name = "dynamic-events")
@Inject
