...
import dev.placeholder.framework.commands.Observed
...
import dev.placeholder.framework.commands.Repeated
import dev.placeholder.framework.commands.Restricted
import dev.placeholder.framework.commands.Root
import dev.placeholder.framework.commands.Scope
import dev.placeholder.framework.commands.Sensitive
import dev.placeholder.framework.commands.graph.CommandGraph
import dev.placeholder.framework.commands.graph.CommandRefresh
import dev.placeholder.framework.commands.reference.PlayerRef
import dev.placeholder.framework.commands.reject
import dev.placeholder.framework.commands.requirePermission
import dev.placeholder.framework.commands.responses
import dev.placeholder.framework.commands.route.CommandDispatcher
import dev.placeholder.framework.commands.route.sensitive
import dev.placeholder.framework.commands.policy.CancelOnExecutorRetire
import dev.placeholder.framework.commands.policy.Confirm
import dev.placeholder.framework.commands.policy.Cooldown
import dev.placeholder.framework.commands.policy.CooldownMode
import dev.placeholder.framework.commands.policy.RateLimit
import dev.placeholder.framework.commands.policy.RateLimitMode
import dev.placeholder.framework.commands.policy.SingleFlight
...
internal class ShowcaseCommands(
    ...
    private fun menu(title: String, vararg entries: Pair<String, dev.placeholder.framework.commands.route.CommandRoute?>): Component {
